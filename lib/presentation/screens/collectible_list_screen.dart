...
import 'package:assetwize/presentation/cubit/items_cubit/collectible_cubit.dart';
...
class CollectibleListScreen extends StatelessWidget {
  const CollectibleListScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) {
            final cubit = CollectibleCubit(GetCollectibleItemsUseCase());
            cubit.fetchCollectibleItems();
            return cubit;
          },
        ),
        BlocProvider(
            ...
            child: Column(
              ...
              children: [
                ...
                AddNewItemTile(
                  ...
                  subtitle: "Curate your collection.",
                ...
                BlocBuilder<CollectibleCubit, CollectibleState>(
