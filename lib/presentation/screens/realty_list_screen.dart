...
import 'package:assetwize/presentation/cubit/items_cubit/realty_cubit.dart';
...
class RealtyListScreen extends StatelessWidget {
  const RealtyListScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) {
            final cubit = RealtyCubit(GetRealtyItemsUseCase());
            cubit.fetchRealtyItems();
            return cubit;
          },
        ),
        BlocProvider(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                AddNewItemTile(
                  title: "New Realty",
                  subtitle: "Curate your Realty collection.",
                  icon: Icons.arrow_forward,
                  onTap: () {},
                ),
                const SizedBox(height: 12),

                BlocBuilder<RealtyCubit, RealtyState>(
