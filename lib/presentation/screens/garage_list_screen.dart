...
import 'package:assetwize/presentation/cubit/items_cubit/garage_cubit.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) {
            final cubit = GarageCubit(GetGarageItemsUseCase());
            cubit.fetchGarageItems();
            return cubit;
          },
        ),
        BlocProvider(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                AddNewItemTile(
                  title: "New Garage",
                  subtitle: "Curate your Garage collection.",
