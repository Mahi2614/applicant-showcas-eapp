...
import 'package:assetwize/presentation/cubit/items_cubit/jewellery_cubit.dart';
...
class JewelleryListScreen extends StatelessWidget {
  const JewelleryListScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) {
            final cubit = JewelleryCubit(GetJewelleryItemsUseCase());
            cubit.fetchJewelleryItems();
            return cubit;
          },
        ),
        BlocProvider(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                BlocBuilder<JewelleryCubit, JewelleryState>(
